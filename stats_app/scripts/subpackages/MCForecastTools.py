...
class MCSimulation:
    ...
    def __init__(self, portfolio_data, weights="", num_simulation=1000, num_trading_days=252):
        ...
        if not "daily_return" in portfolio_data.columns:
            ...
            portfolio_data = pd.concat([portfolio_data, close_df], axis=1)    
            portfolio_data = portfolio_data.reindex(tickers, axis=1)
    ...
    def calc_cumulative_return(self):
        ...
        last_prices = self.portfolio_data.iloc[-1].values.tolist()
        
        # Calculate the mean and standard deviation of daily returns for each stock
        daily_returns = self.portfolio_data.pct_change()
